...
abline()
text(365/2,0,labels = "2015년")
text(365+(365/2),0,labels = "2016년")
text(365+365+(365/2),0,labels = "2017년")
text(365+365+365+(365/2),0,labels = "2018년")
text(365+365+365+365+(365/2),0,labels = "2019년")
...
rec_data.columns = ["sale_date"]
if (file_name[0:2] == '20'):
    rec_data.iloc[0,0] = file_name[0:-12] +'-'+ rec_data.iloc[0,0].replace('월',"-").replace('일',"-")[0:-4]
    rec_data.iloc[1,0] = file_name[0:-12] +'-'+ rec_data.iloc[1,0].replace('월',"-").replace('일',"-")[0:-4]
else :
...
#그래프를 저장할 경로 및 파일명 입력
jpeg(width = 1000, height = 450, filename = "./rec_trend.jpg")
...
library(knitr)
include_graphics("./REC_20180629.jpg")
...
for link in links:
    i= 1 + i
    if link[0:22] == "http://www.zdnet.co.kr":
        link = ""
    if link[0:18] == "https://newsen.com":
        link = ""
